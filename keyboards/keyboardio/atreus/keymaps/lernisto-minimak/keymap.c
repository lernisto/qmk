...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FUNCTION] = LAYOUT(
		...
		OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL),  KC_BRID,                               KC_F11,    KC_F4,     KC_F5,    KC_F6,  C(KC_MINS),
			  KC_SLCK,       KC_PAUS,       KC_MPRV,       KC_MNXT,  KC_STOP,     KC_NO,           KC_NO,   KC_F10,    KC_F1,     KC_F2,    KC_F3,  C(KC_0),
	...
	[_MOUSE] = LAYOUT(
			   ...
			   KC_ACL2,      KC_BTN4,       KC_BTN3,       KC_BTN2,  KC_BTN1,   KC_BTN5,            KC_NO,  UC(0X0080),    KC_EXLM,       KC_AT,    KC_HASH,  UC(0X00F7),
