...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_ISRTNEAO] = LAYOUT(
      ...
      LCTL_T(KC_ESC),   TLL(_NUM),      TLL(_NAV),      TLL(_SYM), OSM(MOD_LSFT),    KC_BSPC,              KC_TAB,  MEH_T(KC_SPC),         KC_NO,       KC_SLSH,   KC_GRV,   RCTL_T(KC_ENT)
		),
	[_MINIMAK] = LAYOUT(
		         KC_Q,       KC_W,           KC_D,           KC_F,       KC_K,                                               KC_Y,          KC_U,          KC_I,     KC_O,   KC_SCLN,
		         KC_A,       KC_S,   LALT_T(KC_R),   LGUI_T(KC_T),       KC_G,                                               KC_H,  RGUI_T(KC_N),  RALT_T(KC_E),     KC_L,      KC_P, 
		      KC_QUOT,       KC_X,           KC_C,           KC_V,       KC_B,          KC_Z,             KC_BSLS,           KC_J,          KC_M,       KC_COMM,   KC_DOT,   KC_SLSH, 
    	      _______,     _______,        _______,        _______,    _______,       _______,             _______,        _______,       _______,       KC_MINS,  _______,   _______
		),
	[_QWERTY] = LAYOUT(
	...
	[_COLEMAK] = LAYOUT(
		         ...
		         KC_A,       KC_R,   LALT_T(KC_S),   LGUI_T(KC_T),       KC_G,                                               KC_M,  RGUI_T(KC_N),  RALT_T(KC_E),     KC_I,      KC_O, 
		      KC_QUOT,       KC_X,           KC_C,           KC_D,       KC_V,          KC_Z,             KC_BSLS,           KC_K,          KC_H,       KC_COMM,   KC_DOT,   KC_SLSH, 
    	     _______,     _______,        _______,        _______,    _______,       _______,             _______,        _______,       _______,       KC_MINS,  _______,   _______
		),
	[_NUM] = LAYOUT(
		     KC_PSCR,       KC_F9,         KC_F10,         KC_F11,     KC_F12,                                            KC_MINS,       KC_P7,     KC_P8,     KC_P9,   KC_PPLS, 
		     KC_SLCK,       KC_F5,          KC_F6,          KC_F7,      KC_F8,                                             KC_EQL,       KC_P4,     KC_P5,     KC_P6,   KC_PSLS, 
		     KC_PAUS,       KC_F1,          KC_F2,          KC_F3,      KC_F4,        KC_F13,            TO(_KYB),        KC_COMM,       KC_P1,     KC_P2,     KC_P3,   KC_PAST, 
		     _______,     _______,        _______,        _______,    _______,       _______,             _______,        _______,    TG(_NUM),     KC_P0,   KC_PDOT,   RCTL_T(KC_PENT)
		),
	[_NAV] = LAYOUT(
		     KC_MUTE,     KC_WH_L,        KC_MS_U,         KC_WH_R,       KC_Q,                                           KC_PGUP,     KC_HOME,     KC_UP,    KC_END,   KC_WBAK,  
		     KC_VOLU,     KC_MS_L,        KC_MS_D,         KC_MS_R,     KC_DEL,                                           KC_PGDN,     KC_LEFT,   KC_DOWN,   KC_RGHT,   KC_WFWD,
		     KC_VOLD,     KC_WH_U,        KC_BTN1,         KC_WH_D,    KC_BTN2,       KC_MPRV,              KC_MNXT,      KC_MPLY,     KC_ACL0,   KC_ACL1,   KC_ACL2,   KC_BTN3,  
		    _______,      _______,        _______,         _______,    _______,       _______,              _______,      _______,    TG(_NAV),  _______,    _______,  _______
		), 		
	[_SYM] = LAYOUT(
		     KC_EXLM,       KC_AT,        KC_HASH,          KC_DLR,    KC_PERC,                                            KC_CIRC,     KC_AMPR,    KC_ASTR,   KC_PIPE,   KC_COLN, 
		     KC_AGIN,     KC_HOME,         KC_END,          KC_INS,     KC_DEL,                                       LGUI(KC_SPC),     KC_LPRN,    KC_LCBR,   KC_LBRC,   KC_PGUP, 
	         KC_UNDO,      KC_CUT,        KC_COPY,         KC_PSTE,    KC_FIND,        KC_APP,              KC_CAPS,       KC_SLEP,     KC_RPRN,    KC_RCBR,   KC_RBRC,   KC_PGDN, 
		     _______,     _______,        _______,         _______,    _______,       _______,              _______,       _______,    TG(_SYM),  _______,   KC_TILD,   _______
		),
	[_KYB] = LAYOUT(
		       KC_NO,       KC_NO,     KC_NO,      KC_NO,      KC_NO,                                              KC_NO,         KC_NO,        KC_NO,        KC_NO,        KC_NO, 
		       KC_NO,       KC_NO,     KC_NO,      KC_NO,      KC_NO,                                              KC_NO, TO(_ISRTNEAO), TO(_MINIMAK),  TO(_QWERTY), TO(_COLEMAK),   
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  TD(DANCE_58),     KC_MS_BTN2,         KC_MS_WH_UP,            KC_MS_WH_DOWN,         _______,                                         KC_MS_BTN1,       KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   KC_NO, 
